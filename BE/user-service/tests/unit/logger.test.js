...
describe('logger', () => {
  ...
  describe('log level from environment', () => {
    ...
    it('should accept "error" as a valid log level', () => {
  ...
  describe('service identity', () => {
    it('should carry defaultMeta with service "user-service"', () => {
      const logger = require('../../src/utils/logger');
      expect(logger.defaultMeta).toBeDefined();
      expect(logger.defaultMeta.service).toBe('user-service');
    });
  });

  describe('transports in test environment', () => {
  ...
  describe('transports in non-test environment', () => {
    it('should create file transports when NODE_ENV is not "test"', () => {
